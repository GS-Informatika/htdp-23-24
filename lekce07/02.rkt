...
;; Diskuze - slyšeli jste někdy o sebe-referujících datech (data, která obsahují "sama sebe" - stejný typ)?

;; --- List (seznam) ---

;; Diskuze - co je "list" (TODO-list, guest list, shopping list)? Vymyslete další příklady!
...
;; Řekněme že chceme například list pozvaných hostů. Zadefinujme si datový typ
...
;; cons vypadá jako věc kterou už známe - konstruktor struktury se dvěma polemi.
;; První pole může obsahovat libovolnou hodnotu, druhé pole pak libovolný list.
...
;; ConsPair může obsahovat libovolnou hodnotu i v druhém poli (right)
#; (make-pair "a" '())
#; (make-pair "b" "c")

;; List může v druhém poli obsahovat pouze list - je tzv. "checked"
#; (cons "a" '())
#; (cons "b" "c") ; error

;; Poznámka - můžeme vytvořit vlastní checked konstruktor pro ConsPair
...
;; Pokud je cons "checked" konstruktor, pak by struktura kterou vytváří měla mít
