...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 06-abstraction-of-types) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (filter-list positive? '(-2 0 4 7 -3)) '(4 7))
