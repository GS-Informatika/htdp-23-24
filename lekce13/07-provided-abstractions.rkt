...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 07-provided-abstractions) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; ------- VESTAVĚNÉ ABSTRAKCE -------
