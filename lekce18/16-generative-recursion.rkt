...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 16-generative-recursion) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; ----------------- Generativní rekurze -----------------
...
;;  Rekurzi lze použít i bez hledění na strukturu dat.
...
;; První dvě nemohou fungovat, funkce musí "rekurzit"
;; přes oba parametry.
...
;; Čtvrtý template ale dělá decoupling zase příliš.
;; Procesování listu a odčítání musí být prováděno najednou.

;; Výsledek: Strukturální přístup je v tomto problému k ničemu!
